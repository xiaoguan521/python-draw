...
# 读取 CSV 文件
df = pd.read_csv("2024-04-22接口调用频率.csv")
...
# 添加 x 轴数据，一天中每分钟的时间
x_data = pd.date_range(start='2024-04-22 00:00',
                       end='2024-04-22 23:59', freq='T')
...
line.set_global_opts(
    ...
    legend_opts=opts.LegendOpts(
        pos_right=60,  pos_bottom=100, type_="scroll", page_button_position="start", page_button_gap=10, orient="vertical", item_gap=15),
    toolbox_opts=opts.ToolboxOpts(is_show=True, pos_left=120),
)

# 保存为 HTML 文件
line.render("22pt接口调用频率.html")
